...
task :create_app_vhost => [:create_app_dir] do
  ...
  config = StringIO.new
  config.puts "# Autogenerated by Flippo. Do not edit. Changes will be overwritten. Edit local.conf instead."
  config.puts "server {"
  ...
  local = StringIO.new
  local.puts "# You can put custom Nginx configuration here. This file will not be overrwitten by Flippo."
  local.rewind
